...
class HashMap:
    ...
    def __init__(self, load_factor=1.00):
        ...
        self.bucket = 5       # Number of spots in table
...
ht.__setitem__("Heat", heat)
ht.__setitem__("Pistons", pistons)
ht.__setitem__("Bulls", bulls)

ht.__setitem__("Hawks", hawks)

ht.__setitem__("Lakers", lakers)
ht.__setitem__("Warriors", warriors)
